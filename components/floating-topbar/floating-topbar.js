...
if (placeholder) {
    ...
    fetch('/components/floating-topbar/floating-topbar.html')
        .then(response => {
        ...
        .then(html => {
            ...
            link.rel = 'stylesheet';
            link.href = '/components/floating-topbar/floating-topbar.css';
            ...
            themeToggleScript.src = '/components/theme-toggle/theme-toggle.js';
